...
class SmartSaveUI(QtWidgets.QDialog):
    ...
    def create_ui(self):
        ...
        self.folder_browe_btn = QtWidgets.QPushButton("...")
        layout = QtWidgets.QHBoxLayout()
        layout.addWidget(self.folder_le)
        layout.addWidget(self.folder_browe_btn)
...
class SceneFile(object):
    ...
    def increment_save(self):
        ...
        If the existing version of a file already exists, it should increment from the largest version number available in the folder.
